...
void Game::render() { 
	...
	SDL_SetRenderDrawColor(renderer, TextureManager::Instance()->getRBG1(), TextureManager::Instance()->getRBG2(), TextureManager::Instance()->getRBG3(), 255);
...
void Game::handleEvents() {
	...
	if (SDL_PollEvent(&event)) {
		...
		case SDL_MOUSEMOTION:
			...
			TextureManager::Instance()->updateRBG(mx, my);
			break;
		default: 
			break;
		}
